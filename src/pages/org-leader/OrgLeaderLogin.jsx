...
function OrgLeaderLogin() {
  ...
  const inputCls = "w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-400";
            ...
            {mode === 'login' ? (
              <form onSubmit={handleLogin} className="flex flex-col gap-5">
                ...
                <button type="button" onClick={() => { setMode('signup'); setError(''); }}
                  className="w-full py-3 border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input type="text" value={verificationCode} onChange={(e) => setVerificationCode(e.target.value)} placeholder={t('orgLeaderLogin.verificationCodePlaceholder', '000000')} required maxLength={6}
                        className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm text-center tracking-[0.3em] font-mono text-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-400 placeholder:tracking-[0.3em]" />
                    </div>
                    <button type="submit" disabled={loading} className="w-full py-3 bg-primary text-white font-bold rounded-xl shadow-lg shadow-primary/20 hover:bg-primary-dark disabled:opacity-60 disabled:cursor-not-allowed transition-all text-sm flex items-center justify-center gap-2">
                    ...
                    <button type="button" onClick={() => { setCodeSent(false); setVerificationCode(''); }}
                      ...
                      {t('orgLeaderLogin.resendCode', '← Resend code')}
                    </button>
                  </>
                )}
